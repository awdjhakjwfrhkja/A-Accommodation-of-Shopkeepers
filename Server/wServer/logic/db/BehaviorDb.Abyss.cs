        ...
        private _ Abyss = () => Behav()
            .Init("Archdemon Malphas",
                new State(
                    ...
                    new State("basic",
                        ...
                        new Reproduce("Malphas Missile", densityMax: 1, densityRadius: 1, coolDown: 1000),
           ...
           .Init("Abyss Idol",
            new State(
                ...
                new State("Phase 1",
                    new Shoot(count: 8, projectileIndex: 1, radius: 5, fixedAngle: 2, coolDown:2500),
                    new Shoot(count: 16, projectileIndex: 0, radius: 5, fixedAngle: 0, coolDown: 5000),
                    new Shoot(30, 3, 10, 2, predictive: .5, coolDown: 1000),
                    new Shoot(30, 6, 10, 2, predictive: .5, coolDown: 2500)
                    )
                    ), 
                 new Threshold(0.025,
                    new ItemLoot("Potion of Vitality", 1.0),

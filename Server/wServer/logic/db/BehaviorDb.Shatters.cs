    ...
    partial class BehaviorDb
    {
        ...
        #region minions
            ...
            new State(
                ...
                new State("Throw",
                    new TossObject("shtrs Ice Portal", 5, coolDown: 900, coolDownOffset: 7000),
           ...
           .Init("shtrs Fire Adept",
            new State(
                ...
                new State("Throw",
                    new TossObject("shtrs Fire Portal", 5, coolDown: 900, coolDownOffset: 7000),
                    new TimedTransition(1000, "Main")
                )
                  ))
           ...
           .Init("shtrs Ice Shield",
            ...
            new State(
                ...
                new State("Throw",
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new TossObject("shtrs Firebomb", 1, 0, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 2, 270, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 3, 225, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 4, 160, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 5, 140, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 6, 120, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 6, 340, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 5, 320, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 4, 300, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 3, 45, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 2, 90, coolDown: 5000),
                    new TossObject("shtrs Firebomb", 1, 180, coolDown: 5000),
        ...
        #region TFK minions
            ...
            .Init("shtrs Green Crystal",
                new State(
                    new HealGroup(20, "idkanymore", 2000, 500),
                    new State("orbit",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
        ...
        #region bosses
                ...
                new State(
                    ...
                    new State("BEGIN",
                        ...
                        new State("Swirl Shot",
                            ...
                            new Taunt("CONSUME!"),
                            new TossObject("shtrs Blobomb", 12, 210, 100000),
                            new TossObject("shtrs Blobomb", 7, 210, 100000),
                            new TossObject("shtrs Blobomb", 7, 150, 100000),
                            new TossObject("shtrs Blobomb", 12, 150, 100000),
            ...
            .Init("shtrs The Forgotten King",
                new State(
                    ...
                    new State("1st",
                        new Taunt("Oh, so you want to fight me? So be it."),
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new ConditionalEffect(ConditionEffectIndex.Invisible),
                        new ConditionalEffect(ConditionEffectIndex.Stasis),

...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Candy Gnome",
            new State(
                new DropPortalOnDeath("Candyland Portal", probability: 50),
                new Prioritize(
                    new StayBack(1.0, 55),
                    new Wander(1.4)
                    )
        ...
        .Init("Swoll Fairy",
            new State(
                ...
                new State("1",
                    new Wander(0.3),
                    new Shoot(10, 2, shootAngle: 30, projectileIndex: 0, coolDown: 200),
                    new TimedTransition(4000, "2")
                    ),
                new State("2",
                    new Wander(0.3),
                    new Shoot(10, 8, shootAngle: 45, projectileIndex: 1, fixedAngle: 0, coolDown: 500),
                    new TimedTransition(4000, "1")
                    )
                ),
                new Threshold(0.01,
        ...
        .Init("Candyland Boss Spawner",
            new State(
                ...
                new State("Waiting",
                    new Order(99, "Candyland Spawner", "1"),
                ...
                new State("Check",
                 ...
                 new State("Main",
                    new EntitiesNotExistsTransition(999, "Main2", "Gigacorn", "MegaRototo", "Spoiled Creampuff", "Desire Troll", "Swoll Fairy", "Unicorn", "Wishing Troll", "Big Creampuff", "Rototo", "Beefy Fairy")
                    ),
                 new State("Main2",
                     new TimedTransition(2500, "Pony Check 2", true),
                     new TimedTransition(2500, "Desire Troll Check 2", true),
                     new TimedTransition(2500, "Spoiled Creampuff Check 2", true),
                     new TimedTransition(2500, "MegaRototo Check 2", true),
                     new TimedTransition(2500, "Swoll Fairy Check 2", true)
                     ),
                ...
                new State("Pony",
                    ...
                    new EntitiesNotExistsTransition(999, "Waiting", "Gigacorn", "MegaRototo", "Spoiled Creampuff", "Desire Troll", "Swoll Fairy")
                    ),

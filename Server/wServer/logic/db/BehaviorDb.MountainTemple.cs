        ...
        .Init("Daichi the Fallen",
            new State(
                ...
                new State("movetomiddle",
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new Timed(2000, new Taunt("Ha Ha fools, you are too late. lord Xil will arrive soon in this realm.")),
                ...
                new State("goinvis",
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new SetAltTexture(1),
                    new Timed(250, new SetAltTexture(2)),
                    new Timed(500, new SetAltTexture(3)),
                    new Timed(750, new SetAltTexture(4)),
                ...
                new State("govis",
                    ...
                    new SetAltTexture(3),
                    new Timed(250, new SetAltTexture(2)),
                    new Timed(500, new SetAltTexture(1)),
                    new Timed(750, new SetAltTexture(5)),

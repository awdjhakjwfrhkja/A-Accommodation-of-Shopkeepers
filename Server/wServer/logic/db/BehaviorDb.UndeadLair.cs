    ...
    partial class BehaviorDb
    {
        private _ UndeadLair = () => Behav()
            .Init("Septavius the Ghost God",
                new State(
                    ...
                    new State("Spawn Minions",
                        new State("Spawn the Fegits",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new Spawn("Ghost Warrior of Septavius", 2, 0.8),
                            new Spawn("Ghost Mage of Septavius", 2, 0.8),
                            new Spawn("Ghost Rogue of Septavius", 2, 0.8),
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Quiver of Doom", .005),
                    new ItemLoot("Demon Hide Armor", .005),
                    new ItemLoot("Ring of Doom", .005),
        ...
        .Init("Lair Skeleton King",
            new State(
                ...
                new State("Follow",
                    new NoPlayerWithinTransition(11, "Wander"),
                    new Shoot(10, projectileIndex: 0, count: 3, shootAngle: 20, coolDown: 1000),
                    new Wander(0.4),
        ...
        .Init("Lair Big Brown Slime",
           ...
           new TransformOnDeath("Lair Little Brown Slime", min: 5, max: 6, probability: 1)
           ))
        .Init("Lair Little Brown Slime",
            new State(
                new Wander(0.4),
                new Shoot(10, projectileIndex: 0, count: 3, shootAngle: 20, coolDown: 500)
                 ))
        .Init("Lair Big Black Slime",
            new State(
                new Wander(0.4),
                new Shoot(10, count: 1, coolDown: 500),
                new TransformOnDeath("Lair Medium Black Slime", min: 3, max: 4, probability: 1)
           ))
        .Init("Lair Medium Black Slime",
            new State(
                new Wander(0.4),
                new TransformOnDeath("Lair Little Black Slime", min: 5, max: 6, probability: 1),
                new Shoot(10, count: 1, coolDown: 500)
                ))

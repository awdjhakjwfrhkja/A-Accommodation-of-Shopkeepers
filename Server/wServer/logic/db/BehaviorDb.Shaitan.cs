            ...
            .Init("md1 Head of Shaitan",
                new State(
                    ...
                    new State("4",
                        ...
                        new State("nothin"),
                        new State("5",
                            new Shoot(9, 1, projectileIndex: 0, coolDown: 1000),
                    ...
                    new State("18",
                        ...
                        new State("20",
                            new TossObject("md1 Lava Makers", 20, coolDown: 500),
                    ...
                    new State("94",
                        ...
                        new GroundTransform("Earth Light", 6),
                        new TimedTransition(2000, "95")
                        ),
                    new State("95",
                        new Shoot(999, 5, 72, 0, 0),
                        new Suicide()
                        )
            ...
            .Init("md1 Right Hand of Shaitan",
                new State(
                    ...
                    new State("3",
                        ...
                        new State("15",
                            new Shoot(999, 6, 25, 0, 90, coolDown: 500),
                            new TimedTransition(4000, "16")
                            ),
                        new State("16",
                            new Follow(0.8, 99, 1),
                            new Shoot(999, 6, 60, 2, 90, coolDown: 750),

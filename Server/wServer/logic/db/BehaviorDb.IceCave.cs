    ...
    partial class BehaviorDb
    {
        ...
        .Init("ic Esben the Unwilling",
            new State(
               ...
               new State("K",
                   new ConditionalEffect(ConditionEffectIndex.Invincible),
                   new SetAltTexture(1),
                   new Shoot(20, 8, projectileIndex: 1, coolDownOffset: 1000, coolDown: 6000),
                   new Shoot(20, 10, projectileIndex: 1, coolDownOffset: 2000, coolDown: 6000),
                   new Shoot(20, 12, projectileIndex: 1, coolDownOffset: 3000, coolDown: 6000),
                   new Shoot(20, 14, projectileIndex: 1, coolDownOffset: 4000, coolDown: 6000),
                   new Shoot(20, 16, projectileIndex: 1, coolDownOffset: 5000, coolDown: 6000),
                   new Shoot(20, 18, projectileIndex: 1, coolDownOffset: 6000, coolDown: 6000),
                   new Shoot(20, 20, projectileIndex: 1, coolDownOffset: 7000, coolDown: 6000),
              ...
              new State("FF",
                    ...
                    new Shoot(20, 100, projectileIndex: 0, fixedAngle: 360, coolDownOffset: 3500, coolDown: 14000),
                    new Taunt("Icicles, rend their flesh!"),
              ...
              new State("die",
                  ...
                  new SetAltTexture(3),
                  new Spawn("ic CreepyTime", 8, 1, coolDown: 99999999),
                  new Wander(1.5)
                    )
                )
            )
        ...
        .Init("ic Whirlwind",
            new State(
                ...
                new State("shoot1",
                    new Shoot(5, 7, projectileIndex: 0, coolDown: 2500),
                    new TimedTransition(4000, "shoot2")
                    ),
                new State("shoot2",
                    new Shoot(5, 7, projectileIndex: 1, coolDown: 2000),

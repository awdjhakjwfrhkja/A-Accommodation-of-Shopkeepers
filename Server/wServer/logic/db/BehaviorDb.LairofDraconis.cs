        ...
        private _ LairofDraconis = () => Behav()
            .Init("NM Altar of Draconis",
                ...
                new State("normal",
                    ...
                    new PlayerTextTransition("blue check normal", "blue"),
                    new PlayerTextTransition("red check normal", "red"),
                    new PlayerTextTransition("green check normal", "green"),
                    new PlayerTextTransition("black check normal", "black")
                    ),
                new State("normal2",
                ...
                new State("hardmode",
                    new Taunt(true, "Choose the Dragon Soul you wish to commune with!"),
                    new PlayerTextTransition("blue check hardmode", "blue"),
                    new PlayerTextTransition("red check hardmode", "red"),
                    new PlayerTextTransition("green check hardmode", "green"),
                    new PlayerTextTransition("black check hardmode", "black")
                    ),
                new State("hardmode2",
                ...
                new State("Ivory Wyvern Portal",
                    new DropPortalOnDeath("Ivory Wyvern Portal", 1),
                    new Suicide()
                    ),
            ...
            .Init("NM Blue Dragon God",
                new State(
                    ...
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new State("1",
                            new EntityNotExistsTransition("NM Black Dragon God", 20000, "pre_2")
                            ),
                        new State("pre_2",
        ...
        .Init("NM Blue Dragon Spawner",
            new State(
                ...
                new State("normal",
                    ...
                    new EntityNotExistsTransition("NM Blue Dragon God", 1000, "hardmode")
                    ),
                new State("hardmode",
                    new Spawn("NM Blue Dragon God Hardmode", 1, 0),
                    new EntityNotExistsTransition("NM Blue Dragon God Hardmode", 1000, "despawn")
                    ),
                new State("despawn",
                    new Decay(0)
                    )
            ...
            .Init("NM Blue Dragon God Hardmode",
                new State(
                    ...
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new State("1",
                            new EntityNotExistsTransition("NM Black Dragon God Hardmode", 100, "pre_2")
                            ),
                        new State("pre_2",
                            new Order(999, "drac wall blue", "spawn"),
                            new TimedTransition(500, "2")
        ...
        .Init("NM Red Dragon Spawner",
            new State(
                ...
                new State("normal",
                    ...
                    new EntityNotExistsTransition("NM Red Dragon God", 1000, "hardmode")
                    ),
                new State("hardmode",
                    new Spawn("NM Red Dragon God Hardmode", 1, 0),
                    new EntityNotExistsTransition("NM Red Dragon God Hardmode", 1000, "despawn")
                    ),
                new State("despawn",
                    new Decay(0)
                    )
            ...
            .Init("NM Red Dragon God",
                new State(
                    ...
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new State("1",
                            new EntityNotExistsTransition("NM Blue Dragon God", 20000, "2")
                            ),
                        new State("2",
                            new Flash(0xFFFFFF, 0.2, 12),
            ...
            .Init("NM Red Dragon God Hardmode",
                new State(
                    ...
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new State("1",
                            new EntityNotExistsTransition("NM Blue Dragon God Hardmode", 20000, "2")
                            ),
                        new State("2",
                            new Flash(0xFFFFFF, 0.2, 12),
                            new TimedTransition(2500, "pre_3")
            ...
            .Init("NM Green Dragon God",
                new State(
                    ...
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new State("1",
                            new EntityNotExistsTransition("NM Red Dragon God", 20000, "pre_2")
                            ),
                        new State("pre_2",
            ...
            .Init("NM Green Dragon God Hardmode",
                new State(
                    ...
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new State("1",
                            new EntityNotExistsTransition("NM Red Dragon God Hardmode", 20000, "pre_2")
                            ),
                        new State("pre_2",
                            new Order(999, "drac wall green", "spawn"),
                            new TimedTransition(500, "2")
        ...
        .Init("NM Green Dragon Spawner",
            new State(
                ...
                new State("normal",
                    ...
                    new EntityNotExistsTransition("NM Green Dragon God", 1000, "hardmode")
                    ),
                new State("hardmode",
                    new Spawn("NM Green Dragon God Hardmode", 1, 0),
                    new EntityNotExistsTransition("NM Green Dragon God Hardmode", 1000, "despawn")
                    ),
                new State("despawn",
                    new Decay(0)
                    )
            ...
            .Init("NM Black Dragon God",
                new State(
                    ...
                    new State("4",
                        ...
                        new Reproduce("NM Black Dragon Shadow", 99, 2, 0),
                        new State("5",
        ...
        .Init("NM Black Dragon Spawner",
            new State(
                ...
                new State("normal",
                    ...
                    new EntityNotExistsTransition("NM Black Dragon God", 1000, "hardmode")
                    ),
                new State("hardmode",
                    new Spawn("NM Black Dragon God Hardmode", 1, 0),
                    new EntityNotExistsTransition("NM Black Dragon God Hardmode", 1000, "despawn")
                    ),
                new State("despawn",
                    new Decay(0)
                    )

    ...
    partial class BehaviorDb
    {
        ...
        .Init("Dr Terrible Rampage Cyborg",
            new State(
                ...
                new State("explode",
                    ...
                    new Shoot(10, count: 8, projectileIndex: 2, fixedAngle: 0),
                    new Suicide()
                )
                    )
            )
        ...
        .Init("Green Potion",
            new State(
                ...
                new State("explode",
                      new Shoot(10, count: 6, projectileIndex: 0, fixedAngle: 0),
                      new Suicide()
                    )
                )
            )
        .Init("Red Gas Spawner UL",
            new State(
                ...
                new State("ON",
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new Shoot(10, count: 20, projectileIndex: 0, fixedAngle: 0)
                )
                )
        )

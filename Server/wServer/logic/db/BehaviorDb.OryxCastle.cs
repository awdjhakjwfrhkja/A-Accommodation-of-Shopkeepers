...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ OryxCastle = () => Behav()
            ...
            .Init("Oryx Insect Commander",
                new State(
                      new State("lol jordan is a nub",
                          ...
                          new Reproduce("Oryx Insect Minion", 10, 20, 1, regionRange: 50),
            ...
            .Init("Oryx Suit of Armor",
                new State(
                      ...
                      new State("attack me pl0x",
                          new HpLessTransition(.99, "jordan is stanking")
                          ),
                      ...
                      new State("heal",
                          ...
                          new HealEntity(range: 1, name: "Self", healAmount: 200, coolDown: 1),
            ...
            .Init("Oryx Brute",
                new State(
                      ...
                      new State("piddle",
                          ...
                          new Reproduce("Oryx Eye Warrior", 10, 4, coolDown: 1750, regionRange: 2),
         ...
         .Init("Chamber portal maker",
                new State(
                    new ConditionalEffect(ConditionEffectIndex.Invincible, true),
                    new DropPortalOnDeath(target: "Oryx Chamber Portal", probability: 1),
                    new State("Wait",
                        new EntityNotExistsTransition(target: "Oryx Stone Guardian Right", dist: 50, targetState: "Wait2")
                        ),
                    new State("Wait2",
                        new EntityNotExistsTransition(target: "Oryx Stone Guardian Left", dist: 50, targetState: "Transform")
                        ),
                    new State("Transform",
                        new Suicide()
                        )

    ...
    partial class BehaviorDb
    {
        ...
        .Init("Murderous Megamoth",
             new State(
                 new State("idle",
                     ...
                     new Shoot(25, projectileIndex: 1, count: 1, shootAngle: 0, coolDown:250, coolDownOffset: 750)
                     )
                ),
                new Threshold(0.025,
        ...
        .Init("Mini Larva",
            new State(
                new State("idle",
                    ...
                    new Shoot(10, count: 4, projectileIndex: 0),
                    new EntityNotExistsTransition("Murderous Megamoth", 50, "die")
                        ),
                    new State("die",
                        new Suicide()
                        )
        ...
        .Init("Epic Mama Megamoth",
            new State(
                ...
                new State("idle",
                    ...
                    new Shoot(25, projectileIndex: 0, count: 3, shootAngle: 10, coolDown: 200, coolDownOffset: 1)
                    ),
                new State("change",
        ...
        .Init("Epic Larva",
            new State(
                ...
                new State("shoot1",
                    ...
                    new Shoot(10, count: 8, projectileIndex: 0, coolDownOffset: 1500),
                    new Shoot(10, count: 4, projectileIndex: 0, coolDownOffset: 2000)
                    ),
                new State("shoot4",
                    //toss Larva Puke
                    new Follow(1.5, 8, 1),
        ...
        .Init("Woodland Ultimate Squirrel",
            new State(
                ...
                new Shoot(radius: 7, count: 1, projectileIndex: 0, shootAngle: 15, coolDown: 1000)
                ),
                new Threshold(0.025,
        ...
        .Init("Wooland Armor Squirrel",
            new State(
                new State("only",
                    ...
                    new Wander(0.7),
                    new Shoot(radius: 7, count: 3, projectileIndex: 0, shootAngle: 20, coolDown: 1000)
                    )
                ),
                new Threshold(0.025,
                    new ItemLoot("Speed Sprout", 0.05)
        ...
        .Init("Woodland Silence Turret",
            new State(
                ...
                new State("idle",
                    new Shoot(10, count: 8, projectileIndex: 0)
                    )
                )
            )

               ...
               .Init("Archdemon Malphas Deux",
                new State(
                    ...
                    new State("basic",
                        ...
                        new Reproduce("Malphas Missile", densityMax: 1, coolDown: 1800),
            ...
            .Init("Murderous Megamoth Deux",
             new State(
                 ...
                 new State("idle",
                     ...
                     new Reproduce("Mini Larva", coolDown: 500, densityMax: 20, densityRadius: 99),
                     new Shoot(25, projectileIndex: 0, count: 2, shootAngle: 10, coolDown: 1000, coolDownOffset: 500),
                     new Shoot(25, projectileIndex: 1, count: 1, shootAngle: 0, coolDown: 400, coolDownOffset: 1)
                     )
                 ),
                new Threshold(0.01,
                    new ItemLoot("Sunshine Shiv", 0.02),

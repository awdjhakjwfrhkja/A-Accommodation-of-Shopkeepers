...
public class TitleView extends Sprite {
    ...
    private function makeMenuOptionsBar():MenuOptionsBar {
        ...
        _local7.addButton(_local1, MenuOptionsBar.CCENTER);
        _local7.addButton(_local2, MenuOptionsBar.LEFT1);
        _local7.addButton(_local5, MenuOptionsBar.LEFT3);
        _local7.addButton(_local3, MenuOptionsBar.RIGHT1);
        _local7.addButton(_local4, MenuOptionsBar.RIGHT2);
        _local7.addButton(_local6, MenuOptionsBar.LEFT2);
        return (_local7);
    }

...
public class ObjectLibrary {
    ...
    public static function getRedrawnTextureFromType(_arg1:int, _arg2:int, _arg3:Boolean, _arg4:Boolean = true, _arg5:Number = 5) : BitmapData
    {
        ...
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,65535,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("SG"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,16033092,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("UTG"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,16744118,_arg4,_arg5);
        }

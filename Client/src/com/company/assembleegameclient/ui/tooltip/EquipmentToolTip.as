    ...
    private function addTierText():void {
        ...
        if (((((_local1) && (_local2))) && (_local3))) {
            ...
            if (_local4) {
                ...
                else if (this.objectXML.hasOwnProperty("L")) {
                    this.tierText.setColor(0xCBAC00);
                    this.tierText.setStringBuilder(new StaticStringBuilder("Lunar"));
                }
                else if (this.objectXML.hasOwnProperty("S")) {
                    this.tierText.setColor(0xFF9900);
                    this.tierText.setStringBuilder(new StaticStringBuilder("ST"));
                }
                else {

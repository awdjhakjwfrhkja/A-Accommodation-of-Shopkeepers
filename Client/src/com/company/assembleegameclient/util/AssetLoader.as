...
public class AssetLoader {
    ...
    private function addImages():void {
        ...
        AssetLibrary.addImageSet("lostHallsChars8x8", new EmbeddedAssets.lostHallsChars8x8Embed_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("lostHallsChars16x16", new EmbeddedAssets.lostHallsChars16x16Embed_().bitmapData, 16, 16);
